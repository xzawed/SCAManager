...
[![Tests](https://img.shields.io/badge/Tests-1004_passing-brightgreen?style=flat-square&logo=pytest&logoColor=white)](tests/)
[![E2E](https://img.shields.io/badge/E2E-38_passing-brightgreen?style=flat-square&logo=playwright&logoColor=white)](e2e/)
[![pylint](https://img.shields.io/badge/pylint-9.91%2F10-brightgreen?style=flat-square&logo=python&logoColor=white)](src/)
...
| **정적 분석** | pylint · flake8 · bandit (Python), 50개 언어 AI 체크리스트 |
...
GitHub Push/PR
  └─ POST /webhooks/github  (HMAC-SHA256 서명 검증)
       └─ BackgroundTask: run_analysis_pipeline()
            ...
            │    ├─ analyze_file() × N  (pylint · flake8 · bandit, .py만)
            │    └─ review_code()       (Claude AI, 50개 언어 체크리스트 적용)
            │
