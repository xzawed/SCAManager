...
| **AI 리뷰** | Claude 가 diff 를 리뷰합니다. 분석 한 건이 Claude 호출 한 번이며, 요금은 본인 Anthropic 계정에 청구됩니다. | **켜짐** |
...
B 입니다. 그 실행은 모든 평균에서도 제외되므로, AI 리뷰를 거치지 않은 점수가 거친 점수처럼
보이는 일이 없습니다.
...
조용히 건너뜁니다. 전체 목록은 [docs/architecture.md](docs/architecture.md) 에 있습니다.
