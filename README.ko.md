...
#### ♻️ CI-aware Auto Merge 재시도 (Phase 12)
...
| **정적 분석** | pylint · flake8 · bandit (Python) + Semgrep (22개+) + ESLint (JS/TS) + ShellCheck (shell) + cppcheck (C/C++) + slither (Solidity) + RuboCop (Ruby) + golangci-lint (Go) |
