...
class TestSemgrepAnalyzerAttributes:
    def test_name_is_semgrep(self):
        ...
        from src.analyzer.tools.semgrep import _SemgrepAnalyzer
...
class TestSemgrepRegistration:
    def test_module_import_registers_semgrep_in_registry(self):
        # src.analyzer.tools.semgrep 임포트 시 REGISTRY에 _SemgrepAnalyzer가 자동 등록된다
        from src.analyzer.registry import REGISTRY
        import importlib
        import src.analyzer.tools.semgrep  # noqa: F401
        importlib.reload(src.analyzer.tools.semgrep)  # 재로드로 등록 트리거
    ...
    def test_double_import_does_not_duplicate_registry_entry(self):
        ...
        from src.analyzer.registry import REGISTRY, register
        import src.analyzer.tools.semgrep  # noqa: F401
        import importlib
        importlib.reload(src.analyzer.tools.semgrep)
        importlib.reload(src.analyzer.tools.semgrep)
...
class TestSemgrepAnalyzeFileIntegration:
    ...
    def test_semgrep_skipped_for_python_file_when_not_installed(self):
        ...
        import src.analyzer.tools.semgrep
        from src.analyzer.registry import REGISTRY
