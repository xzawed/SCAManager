...
## 현재 수치 (2026-05-18 기준 — **사이클 103**: auto-merge 재시도 안정성 개선 (#479) — cron fallback + has_hooks retriable + unknown ci_status retriable): 130+ PR #188~#479 — 누적 정책 본문 19건 + 메모리 18건. 전체 2968 수집 (2964 passed, 4 skipped, 단위 2814 + 통합 154) / E2E 96 / pylint **10.00/10**
