...
## 현재 수치 (2026-05-14 기준 — **사이클 97**: P0 경로 하드코딩 수정 (#420) + 문서 정비 (#421) + Issue #408 기능 구현 (#423) + scripts 하드코딩 경로 제거 + dashboard async 블로킹 수정 (#426) + 랜딩 페이지 추가 (#428) + landing phantom token 수정 (#429) + CodeQL unused import 해소 (#431)): 130+ PR #188~#431 — 누적 정책 본문 19건 + 메모리 30건 (활성 28 + deprecated 2). 단위 2914 / 통합 129 / E2E 96 / pylint **10.00/10**
