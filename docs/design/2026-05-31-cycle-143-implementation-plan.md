...
- [ ] **Step 6: Codex 검증 의뢰 (push 전, 정책 18) → push → PR**  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
## 변경 내용
- 정책 18 Codex 검증 의뢰 체크리스트 포함  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
```
- **완료 시 필수 6-step**: 작업이 완료되면 반드시 ① 커밋 → ② Codex 검증 의뢰 (push 전, 정책 18) → ③ `git push` → ④ PR 생성(`gh pr create`) → ⑤ ...  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
```

`④ PR 생성` 항목 뒤에 추가:
```
④ PR 생성(`gh pr create`) — **PR 본문에 반드시 `## 🔍 Codex 검증 의뢰 (push 전, 정책 18)` 섹션 포함** (`.github/pull_request_template.md` 사용 또는 수동 추가) →  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
```
...
## 변경 내용
- CLAUDE.md 완료 6-step: PR 본문 Codex 검증 의뢰 섹션 포함 명시  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
- [ ] **Step 6: 커밋 + Codex 검증 의뢰 + push + PR**  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
# Codex 검증 의뢰 후  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
- [ ] **Step 5: 커밋 + Codex 검증 의뢰 + push + PR**  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
