...
> **상태 요약 — 이 표(현재 창) 16행 기준**: 🔴 결정 대기 **1**(R21) · 🟡 착수 가능 **9** · ⏸️ 보류 **1**(R18) · ✅ 완료 **5**.
