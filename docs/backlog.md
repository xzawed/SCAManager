...
> **상태 요약 — 이 표(현재 창) 19행 기준**: 🔴 결정 대기 **1** · 🟡 착수 가능 **10** · ✅ 완료 **8** (grep 실측 2026-08-05).
