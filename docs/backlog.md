...
| 상태 | 건수 | 성격 |
|------|------|------|
| 🔴 결정 대기 | **2** (B5·B6-b) | 사용자 영역 — 다음 사이클 진입 시 회신 요청 의무 |
| 🟡 착수 가능 | **2** (B6-a·B7) | Claude 자율 진행 가능 |
...
**권장 착수 순서**: **B6-a**(auto-merge 무장 — `merge_threshold=60` + 브랜치 보호 없음) → **B7**(heartbeat DB, 긴급도 하향).
🔴 결정 대기 2건(B5·B6-b)은 사용자 회신 전까지 착수 불가.
