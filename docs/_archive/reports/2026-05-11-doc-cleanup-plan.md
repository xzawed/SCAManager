...
권장 수정(당시): `① 커밋 → ② ~~Codex 검증 의뢰~~ → ③ git push → ④ PR 생성 → ⑤ STATE.md 갱신 → ⑥ 아키텍처 동기화` ⛔ *(②는 2026-07-10 폐기 — 현재는 `pytest tests/unit` 전체 게이트)*
...
### PR-A 수정 대상 파일
- [ ] `.codex/hooks.json` — 경로 절대→상대 (또는 환경 감지)  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
- [ ] `.codex/hooks/doc_review_gate.py:16` — `_PROJECT_PREFIXES` 경로 수정  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
...
### ~~Codex 검증 의뢰 (push 전 필수)~~ ⛔ *(폐기 2026-07-10 — 수행 안 함)*
