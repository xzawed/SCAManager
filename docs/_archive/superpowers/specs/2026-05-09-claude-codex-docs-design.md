...
> ⛔ **정책 18 (Claude ↔ Codex mutual 검증) 은 2026-07-10 폐기되었다** — Codex 구독 해지로 `codex` 실행 파일·`AGENTS.md`·`.codex/` 가 모두 제거됐다.
> **본 문서의 Codex 관련 미완료 항목(`- [ ]`)은 수행하지 않는다** (완료·폐기된 작업의 역사 기록).
...
- [ ] AGENTS.md: ~120줄, Codex 역할 명확, CLAUDE.md 정책 참조 포인터 포함  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
- [ ] `.codex/rules/`: 8개 파일 생성, path-scoped frontmatter 포함  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
- [ ] `.codex/agents/`: 5개 파일 정합성 확인  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
- [ ] `.Codex/` 대문자 경로 오류 0건  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
- [ ] 브랜치 `chore/codex-docs-setup` → PR 생성  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
