...
- [ ] **Step 1: AGENTS.md 재작성**  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*
...
```bash
grep -n "\.Codex/" AGENTS.md  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
```

Expected: 출력 없음 (`.Codex/` 대문자 경로 0건)  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
- [ ] **Step 1: 현재 에이전트 설명에서 AGENTS.md 참조 확인**  ⛔ *(폐기 2026-07-10 — 대상 자산 제거됨, 수행 안 함)*

```bash
grep -n "AGENTS.md\|CLAUDE.md\|\.Codex\|\.codex" .codex/agents/*.toml
```

Expected: `CLAUDE.md` 참조 없음, `.Codex/` (대문자) 참조 없음  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
- [ ] **Step 1: `.Codex/` 대문자 경로 오류 전수 검사**  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*

```bash
grep -rn "\.Codex/" AGENTS.md .codex/ 2>/dev/null  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
```
...
- .Codex/ 대문자 경로 오류 전수 제거  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
...
| `.Codex/` 경로 오류 수정 | Task 2 Step 2 |  ⛔ *(폐기 2026-07-10 — Codex 단계 수행 안 함)*
