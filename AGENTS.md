...
| `pipeline.md` | `src/worker/**`, `src/analyzer/**`, `src/scorer/**`, `src/webhook/**`, `src/gate/**` |
...
| `deploy.md` | `railway.toml`, `nixpacks.toml`, `requirements.txt`, `requirements-dev.txt`, `.env.example`, `Procfile`, `alembic.ini` |
